...
import { googleLogoImg } from "../assets/image";
      ...
      <div className="container flex flex-col justify-center items-center h-[100%]">
        <div className="registration border border-white rounded-xl bg-white pt-4 pb-6 px-7 ">
          <div className="text-center pb-8">
            <h3 className=" text-blue-500 font-primary font-bold text-[24px] pb-4">
              Login
            </h3>
            <p className=" font-primary font-normal text-black text-[16px]">
          ...
          <div className="flex flex-col w-[400px] gap-5">
            ...
            <div className="flex items-center justify-between relative">
              ...
              >
                {showpassword ? (
                  <FaEye className="pr-2 text-xl " />
                ) : (
                  <FaEyeSlash className="pr-2 text-xl" />
                )}
              </div>
            </div>
            ...
            <button
              ...
              className="text-center font-primary text-primary font-bold py-3 bg-[blue] rounded-md text-[] "
            >
              Sign In
            </button>
            <span className="text-center border-b-2 pb-4">
              <Link to="/">Forgotten password</Link>
            </span>
            <p className="text-center font-primary font-normal text-[#1C8AC6]">
              Already Have an account ? {""}
              <Link
                className=" font-primary font-normal text-black"
                to="/registration"
              >
                Create new account
              </Link>
        ...
        {/* Continue With Google */}
        <div className="mt-10">
          <div className=" flex justify-center border-2 border-red-500 border-opacity-15 rounded-3xl bg-white py-2 w-[400px]">
            <button
              onClick={handleGoogle}
              className="flex items-center justify-center gap-8  font-primary font-normal text-  [#1C8AC6]"
            >
              <span>
                <img className="w-10 h-10" src={googleLogoImg} alt="" />
              </span>
              Continue With Google
            </button>
          </div>
